...
import com.hkapps.messagepro.utils.NOMEDIA
import java.io.File
...
fun File.toFileDirItem(context: Context) = FileDIRModel(absolutePath, name, context.getIsPathDirectory(absolutePath), 0, length(), lastModified())
