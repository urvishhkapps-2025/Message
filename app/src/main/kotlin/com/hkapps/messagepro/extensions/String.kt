...
fun String.getOTGPublicPath(context: Context) =
    "${context.mPref.OTGTreeUri}/document/${context.mPref.OTGPartition}%3A${substring(context.mPref.OTGPath.length).replace("/", "%2F")}"
...
fun String.getCompressionFormat() = when (getFilenameExtension().lowercase(getDefault())) {
...
fun String.getNameLetter() = normalizeString().toCharArray().getOrNull(0)?.toString()?.uppercase(getDefault()) ?: "A"
...
fun String.getMimeType(): String {
    ...
    return typesMap[getFilenameExtension().lowercase(getDefault())] ?: ""
}
