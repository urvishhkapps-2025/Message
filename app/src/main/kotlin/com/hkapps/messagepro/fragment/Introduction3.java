...
public class Introduction3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        textView.setText(getString(R.string.text_intro_title3));
        textView1.setText(getString(R.string.text_intro_sub_title3));
        Bitmap bitmapLocal1 = Utility.decodeSampledBitmapFromResource(getResources(), R.drawable.icon_placeholder, 500, 500);
