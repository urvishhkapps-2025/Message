...
public class Introduction2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        textView.setText(getString(R.string.text_intro_title2));
        textView1.setText(getString(R.string.text_intro_sub_title2));
        Bitmap bitmapLocal1 = Utility.decodeSampledBitmapFromResource(getResources(), R.drawable.icon_banner_otp, 500, 500);
        iv_img1.setImageBitmap(bitmapLocal1);
        iv_img1.setPadding(100,100,100,100);
