...
import com.hkapps.messagepro.listners.AttachRoomDao
import com.hkapps.messagepro.listners.ConversationsRoomDaoListner
import com.hkapps.messagepro.listners.AttachRoomDaoListner
...
@Database(entities = [ConversationSmsModel::class, AttachmentModel::class, AttachmentSMSModel::class, MessagesModel::class], version = 4)
