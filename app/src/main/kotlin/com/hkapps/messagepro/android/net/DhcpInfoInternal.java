...
public class DhcpInfoInternal {
    ...
    private Collection<com.hkapps.messagepro.android.net.RouteInfo> mRoutes;

    public DhcpInfoInternal() {
        mRoutes = new ArrayList<com.hkapps.messagepro.android.net.RouteInfo>();
    }

    public void addRoute(com.hkapps.messagepro.android.net.RouteInfo routeInfo) {
    ...
    public com.hkapps.messagepro.android.net.LinkAddress makeLinkAddress() {
    ...
    public com.hkapps.messagepro.android.net.LinkProperties makeLinkProperties() {
        com.hkapps.messagepro.android.net.LinkProperties p = new LinkProperties();
    ...
    public void updateFromDhcpRequest(DhcpInfoInternal orig) {
        ...
        if (mRoutes.size() == 0) {
            for (com.hkapps.messagepro.android.net.RouteInfo route : orig.getRoutes()) {
                addRoute(route);
            }
        }
    }
