...
public interface IConnectivityManager extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements IConnectivityManager {
        ...
        public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException {
            switch (code) {
                ...
                case TRANSACTION_establishVpn: {
                    data.enforceInterface(DESCRIPTOR);
                    com.hkapps.messagepro.internal.net.VpnConfig _arg0;
                    if ((0 != data.readInt())) {
                        _arg0 = com.hkapps.messagepro.internal.net.VpnConfig.CREATOR.createFromParcel(data);
                    } else {
                        _arg0 = null;
                    }
                ...
                case TRANSACTION_startLegacyVpn: {
                    data.enforceInterface(DESCRIPTOR);
                    com.hkapps.messagepro.internal.net.VpnProfile _arg0;
                    if ((0 != data.readInt())) {
                        _arg0 = com.hkapps.messagepro.internal.net.VpnProfile.CREATOR.createFromParcel(data);
                    } else {
                        _arg0 = null;
                    }
                ...
                case TRANSACTION_getLegacyVpnInfo: {
                    data.enforceInterface(DESCRIPTOR);
                    com.hkapps.messagepro.internal.net.LegacyVpnInfo _result = this.getLegacyVpnInfo();
                    reply.writeNoException();
                    if ((_result != null)) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
        ...
        private static class Proxy implements IConnectivityManager {
            ...
            @Override
            public android.os.ParcelFileDescriptor establishVpn(com.hkapps.messagepro.internal.net.VpnConfig config) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
            ...
            @Override
            public void startLegacyVpn(com.hkapps.messagepro.internal.net.VpnProfile profile) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
            ...
            @Override
            public com.hkapps.messagepro.internal.net.LegacyVpnInfo getLegacyVpnInfo() throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                com.hkapps.messagepro.internal.net.LegacyVpnInfo _result;
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    mRemote.transact(Stub.TRANSACTION_getLegacyVpnInfo, _data, _reply, 0);
                    _reply.readException();
                    if ((0 != _reply.readInt())) {
                        _result = com.hkapps.messagepro.internal.net.LegacyVpnInfo.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                } finally {
