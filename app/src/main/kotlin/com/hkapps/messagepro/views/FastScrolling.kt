...
import com.hkapps.messagepro.extensions.applyColorFilter
...
class FastScrolling : FrameLayout {
    ...
    fun setViews(recyclerView: RecyclerView, swipeRefreshLayout: SwipeRefreshLayout? = null, callback: ((Int) -> Unit)? = null) {
        ...
        tinyMargin = context.resources.getDimension(R.dimen.margin_2).toInt()
    ...
    fun updateBubbleTextColor() {
        bubble?.setTextColor(context.mPref.textColor)
    }

    fun updateBubbleBackgroundColor() {
        getBubbleBackgroundDrawable()?.setColor(context.mPref.backgroundColor)
    }
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        return when (event.action) {
            ...
            MotionEvent.ACTION_UP, MotionEvent.ACTION_CANCEL -> {
                ...
                if (context.mPref.enablePullToRefresh) {
