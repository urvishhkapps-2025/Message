...
import com.hkapps.messagepro.listners.RecyclerScrollListner
...
open class CustomRecyclerView : RecyclerView {
    ...
    private var lastUp = 0L    // allow only pinch zoom, not double tap
     ...
     var recyclerScrollCallback: RecyclerScrollListner? = null
    ...
    init {
        hotspotHeight = context.resources.getDimensionPixelSize(R.dimen.margin_56)
