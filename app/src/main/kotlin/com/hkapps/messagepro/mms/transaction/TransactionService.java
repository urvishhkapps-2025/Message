                ...
                try {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            if (com.hkapps.messagepro.klinker.android.send_message.Transaction.settings != null) {
                                useSystem = com.hkapps.messagepro.klinker.android.send_message.Transaction.settings
                                        .getUseSystemSending();
                            ...
                            if (useSystem) {
                                try {
                                    ...
                                    com.hkapps.messagepro.mms.transaction.DownloadManager.getInstance().
                ...
                if (mmsNetworkInfo.isConnected()) {
                    ...
                    if (TextUtils.isEmpty(settings.getMmscUrl())) {
                        ...
                        BroadcastUtils.sendExplicitBroadcast(
                                ...
                                new Intent(),
                                com.hkapps.messagepro.klinker.android.send_message.Transaction.MMS_ERROR);
