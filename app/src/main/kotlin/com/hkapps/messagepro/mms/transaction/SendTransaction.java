...
import com.hkapps.messagepro.mms.util.RateController;
    ...
    public void run() {
        ...
        try {
            ...
            if (mTransactionState.getState() != TransactionState.SUCCESS) {
                ...
                Intent intent = new Intent(com.hkapps.messagepro.klinker.android.send_message.Transaction.MMS_ERROR);
                intent.putExtra("stack", builder.toString());
                BroadcastUtils.sendExplicitBroadcast(
                        mContext, intent, com.hkapps.messagepro.klinker.android.send_message.Transaction.MMS_ERROR);
            }
            notifyObservers();
        }
    }
